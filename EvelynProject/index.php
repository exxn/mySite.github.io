        ...
        <div class="sl-slider">
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
            <div class="sl-slide-inner">
              ...
              <blockquote>              
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Adamson University</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>PHP 20,000,000</cite>
              </blockquote>
            </div>
          </div>
  ...
  <div class="properties-listing spacer"> <a href="buysalerent.php" class="pull-right viewall">View All Listing</a>
    ...
    <div id="owl-example" class="owl-carousel">
      <div class="properties">
        ...
        <p class="price">Price: PHP 234,900</p>
  ...
  <div class="spacer">
    <div class="row">
      <div class="col-lg-6 col-sm-9 recent-view">
        <h3>About Us</h3>
        <p>BRIEF description summary<br><a href="about.php">Learn More</a></p>
          ...
          <div class="carousel-inner">
            <div class="item active">
              <div class="row">
                ...
                <div class="col-lg-8">
                  <h5><a href="property-detail.php">Name#1</a></h5>
                  <p class="price">PHP 300,000</p>
            ...
            <div class="item">
              <div class="row">
                ...
                <div class="col-lg-8">
                  <h5><a href="property-detail.php">Name#2</a></h5>
                  <p class="price">PHP 300,000</p>
                  <a href="property-detail.php" class="more">More Detail</a> </div>
              </div>
            </div>
            <div class="item">
              <div class="row">
                ...
                <div class="col-lg-8">
                  <h5><a href="property-detail.php">Name#3</a></h5>
                  <p class="price">PHP 300,000</p>
                  <a href="property-detail.php" class="more">More Detail</a> </div>
              </div>
            </div>
            <div class="item">
              <div class="row">
                ...
                <div class="col-lg-8">
                  <h5><a href="property-detail.php">Name#4</a></h5>
                  <p class="price">PHP 300,000</p>
                  <a href="property-detail.php" class="more">More Detail</a> </div>
              </div>
            </div>
