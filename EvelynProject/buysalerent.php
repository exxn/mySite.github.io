  ...
  <div class="search-form"><h4><span class="glyphicon glyphicon-search"></span> Search for</h4>
    ...
    <div class="row">
            ...
            <div class="col-lg-7">
              <select class="form-control">
                <option>Price</option>
                <option>PHP 150,000 - PHP 200,000</option>
                <option>PHP 200,000 - PHP 250,000</option>
                <option>PHP 250,000 - PHP 300,000</option>
                <option>PHP 300,000 - above</option>
              </select>
            </div>
          </div>
...
<div class="row">
                ...
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="property-detail.php">Property#1</a></h5>
                  <p class="price">PHP 300,000</p> </div>
              </div>
<div class="row">
                <div class="col-lg-4 col-sm-5"><img src="images/properties/2.jpg" class="img-responsive img-circle" alt="properties"></div>
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="property-detail.php">Property#2</a></h5>
                  <p class="price">PHP 300,000</p> </div>
              </div>
...
<div class="row">
                ...
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="property-detail.php">Property#3</a></h5>
                  <p class="price">PHP 300,000</p> </div>
              </div>
...
<div class="row">
                ...
                <div class="col-lg-8 col-sm-7">
                  <h5><a href="property-detail.php">Property#4</a></h5>
                  <p class="price">PHP 300,000</p> </div>
              </div>
...
<div class="pull-left result">Showing: 6 of 100 </div>
...
<div class="row">
     ...
     <!-- properties -->
      ...
      <div class="properties">
        <div class="image-holder"><img src="images/slider/1.jpg" class="img-responsive" alt="properties">
          <div class="status new">New</div>
        </div>
        <h4><a href="property-detail.php">Royal Inn</a></h4>
        <p class="price">Price: PHP 1</p>
